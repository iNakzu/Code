...
c. Cree el método "mejorar_plan()", que actualiza el plan de un cliente: Si tenía
   el plan básico, ahora debe tener el plan avanzado; si tenía el plan avanzado,
   ahora debe tener el plan Premium. Si ya tenía el plan Premium, no se realiza ningún cambio.
d. Implemente la función "comparar(Cliente a, Cliente b)", que devuelve al cliente
   que posee el mejor plan. Se asume que estos clientes nunca tienen el mismo plan.
*/
